...
from DTOs.customization_api_dto import CustomizationRequestDTO, CustomizationResponseDTO
...
def create_weapon():
    ...
    return CustomizationResponseDTO(
        ...
        saved_customizations=[CustomizationDTO(id=saved_custom.id,
                                               ...
                                               customization_model=saved_custom.customization.customization_model) for saved_custom in saved_weapon.customizations]
    ).to_json()
